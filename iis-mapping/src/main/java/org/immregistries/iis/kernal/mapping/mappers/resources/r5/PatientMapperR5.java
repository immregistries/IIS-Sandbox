...
import org.immregistries.iis.kernal.mapping.mappers.fields.r5.ModelNameMapperR5;
import org.immregistries.iis.kernal.mapping.mappers.fields.r5.ModelPhoneMapperR5;
...
public class PatientMapperR5 extends PatientMapper<Patient> implements IR5ResourceMapper<IisPatient, Patient> {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Autowired
	private CodeMapManagerService codeMapManagerService;
	@Autowired
	private ModelAddressMapperR5 modelAddressMapper;
	@Autowired
	private ModelNameMapperR5 modelNameMapper;
	@Autowired
	private ModelPhoneMapperR5 modelPhoneMapper;
	@Autowired
