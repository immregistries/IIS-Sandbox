...
public class ImmunizationRecommendationMapperR5 extends RecommendationMapper<ImmunizationRecommendation, ImmunizationRecommendation.ImmunizationRecommendationRecommendationComponent> implements IR5ResourceMapper<IisRecommendation, ImmunizationRecommendation> {
	...
	public ImmunizationRecommendation.@NotNull ImmunizationRecommendationRecommendationComponent recommendationComponent(ForecastActual forecastActual, CodeMap codeMap) {
		...
		if (vaccinePlanStatus != null) {
			component.setForecastStatus(
				new CodeableConcept().addCoding(vaccinePlanStatus.toR5()));
		}
		/*
		 * ForecastReason
		 */
