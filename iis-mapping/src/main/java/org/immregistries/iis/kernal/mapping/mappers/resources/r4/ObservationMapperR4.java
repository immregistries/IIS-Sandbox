...
public class ObservationMapperR4 extends ObservationMapper<Observation> implements IR4ResourceMapper<ObservationMaster, Observation> {
	@Autowired
	...
	public ObservationReported localObjectReported(Observation o) {
		...
		if (o.hasValueCodeableConcept() && o.getValueCodeableConcept().hasCoding()) {
			...
			observationReported.setValueLabel(
					StringUtils.defaultString(o.getValueCodeableConcept().getCodingFirstRep().getDisplay()));
	...
	private @Nullable Type getObservationReportedValue(ObservationMaster om) {
		Type value = null;
