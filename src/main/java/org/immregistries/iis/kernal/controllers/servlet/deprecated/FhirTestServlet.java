package org.immregistries.iis.kernal.controllers.servlet.deprecated;
...
public class FhirTestServlet extends HttpServlet {
    ...
    // "https://sabbia.immregistries.org/iis";
    // @Autowired
    ...
    //
    // PatientReported pr = (PatientReported)
    // session.getAttribute("patientReported");
    //
    ...
    // }
    // } else if (altVaccineCodeType.equals("CPT") ||
    // altVaccineCodeType.equals("C4")
    ...
    // if (tenant == null) {
    // out.println(
    // " <div class=\"w3-panel w3-yellow\"><p class=\"w3-left-align\">You will need
    // to place the IIS Sandbox Facility Id where the tenantId is indicated.
    // </p></div>");
    // }
    // out.println(
    // "<p>The IIS Sandbox supports multitenancy for FHIR. Which means that
    // resources submitted to the sandbox will be placed in dedicated buckets of
    // data that are separated from data by different tenants (facilities.) This is
    // different than IIS which will merge data from all submitters. The IIS Sandbox
    // keeps submitted data separate to support testing from multiple agencies.
    // </p>");
    // {
    ...
    // out.println(" <td><a href=\"" + patientUrl + "\">" + patientUrl +
    // "</a></td>");
    // out.println(" </tr>");
    // out.println(" <tr>");
    ...
    // out.println(
    // " <td><a href=\"" + patientUrlWithId + "\">" + patientUrlWithId +
    // "</a></td>");
    // out.println(" </tr>");
    // out.println(" <tr>");
    ...
    // Code cvxCode =
    // codeMap.getCodeForCodeset(CodesetType.VACCINATION_CVX_CODE,
    // vr.getVaccineCvxCode());
    // if (cvxCode == null) {
    // continue;
    // }
    //
    ...
    // out.println(" <td>Read</td>");
    // out.println(" <td>GET</td>");
    // out.println(" <td><a href=\"" + immUrlWithId + "\">" + immUrlWithId +
    // "</a></td>");
    // out.println(" </tr>");
    // out.println(" <tr>");
    // out.println(" <td>Update</td>");
    ...
    // out.println(
    // " <input class=\"w3-input\" type=\"radio\" name=\"" + PARAM_FORMAT + "\"
    // value=\""
    ...
    // }
    //
    // public CodeableConcept createCodeableConcept(String value, CodesetType
    // codesetType,
    ...
    // }
    //
    // private void createImmunizationResource(VaccinationReported
    // vaccinationReported,
    // Immunization immunization, Code cvxCode, CodeMap codeMap) {
    //
    // {
    // DateTimeType occurance = new
    // DateTimeType(vaccinationReported.getAdministeredDate());
    ...
    // CodeableConcept ndcCoding =
    // createCodeableConcept(vaccinationReported.getVaccineNdcCode(),
    ...
    //
    // {
    // CodeableConcept mvxCoding =
    // createCodeableConcept(vaccinationReported.getVaccineMvxCode(),
