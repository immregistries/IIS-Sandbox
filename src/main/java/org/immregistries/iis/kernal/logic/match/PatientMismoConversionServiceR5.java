...
public class PatientMismoConversionServiceR5 implements PatientMismoConversionService<org.hl7.fhir.r5.model.Patient> {

	public Patient convert(org.hl7.fhir.r5.model.Patient patient) {
...
//			mismo.setAddressStreet1Alt(address.get);
	...
	public Patient convertIncludingLink(org.hl7.fhir.r5.model.Patient patient) {
