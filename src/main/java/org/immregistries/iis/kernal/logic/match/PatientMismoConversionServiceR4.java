...
public class PatientMismoConversionServiceR4 implements PatientMismoConversionService<org.hl7.fhir.r4.model.Patient> {

	public Patient convert(org.hl7.fhir.r4.model.Patient patient) {
...
//			mismo.setAddressStreet1Alt(address.get);
	...
	public Patient convertIncludingLink(org.hl7.fhir.r4.model.Patient patient) {
		Patient mismo = convert(patient);
