...
@Component
public class FhirRequests extends FhirRequestBase implements  IFhirRequest<Patient,Immunization,Location,Practitioner,Observation> {
	...
	@Autowired
	PractitionerMapperR5 personMapper;
...
//		return patientReported;
	...
	public ModelPerson savePractitioner(ModelPerson modelPerson) {
		Practitioner practitioner = personMapper.getFhirResource(modelPerson);
