...
import org.immregistries.iis.kernal.mapping.mappers.fields.r4.ModelAddressMapperR4;
import org.immregistries.iis.kernal.mapping.mappers.fields.r4.ModelNameMapperR4;
import org.immregistries.iis.kernal.mapping.mappers.fields.r4.ModelPhoneMapperR4;
...
public class PatientMapperR4 extends PatientMapper<Patient> implements IR4Mapper<IisPatient, Patient> {
	...
	public void fillFromFhirResource(IisPatient localPatient, Patient patient) {
		...
		if (raceExtension != null) {
			Stream<Extension> raceExtensionsStream = Stream.concat(
