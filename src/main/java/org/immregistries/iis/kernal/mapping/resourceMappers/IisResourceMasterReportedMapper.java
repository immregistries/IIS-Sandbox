...
public interface IisResourceMasterReportedMapper<Master extends IisMappedToFhirResource, Reported extends Master, FhirResourceType extends IBaseResource> extends IisResourceMasterMapper<Master, FhirResourceType> {
