  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      if (req.getParameter(PARAM_ORG_LOCATION_ID) != null) {
        orgLocationSelected = (OrgLocation) dataSession.get(OrgLocation.class,
            Integer.parseInt(req.getParameter(PARAM_ORG_LOCATION_ID)));
      }
      ...
      List<OrgLocation> orgLocationList = null;
      {
        Query query = dataSession
            .createQuery("from OrgLocation where orgMaster = :orgMaster order by orgFacilityCode");
        query.setParameter("orgMaster", orgAccess.getOrg());
        orgLocationList = query.list();
      }
