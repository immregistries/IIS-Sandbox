	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			out.println("      <li><h4>Record's Matching:</h4>Matching resources using " +
				"<a href='https://github.com/immregistries/mismo-match'>MISMO</a> for Patients, " + //TODO clarify flavor
			...
			out.println("      <li><h4>Master Data Management (MDM):</h4> Expanded from " +
				...
				", using above matching logics, also added a layer to include all the record's identifiers in Golden records");
