...
/**
 * Allows R5 support and retains only golden record
 */
public class ImmunizationsJpaSectionSearchStrategyR5 extends JpaSectionSearchStrategy<Immunization> {
	...
	public boolean shouldInclude(
		...
		if (theCandidate.getStatus() == Immunization.ImmunizationStatusCodes.ENTEREDINERROR) {
			return false;
		}
