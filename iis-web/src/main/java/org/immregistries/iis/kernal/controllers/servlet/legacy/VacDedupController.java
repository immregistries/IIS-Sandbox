    ...
    try {
      ...
      if (action != null) {
        if (action.equals(ACTION_SUBMIT)) {
          VacDedupRequest request = new VacDedupRequest();
          request.setAlgorithm(algorithm);
          ArrayList<VacDedupRequest.ImmunizationItem> items = new ArrayList<>();
          ...
          while (req.getParameter(PARAM_CVX + i) != null) {
            ...
            VacDedupRequest.ImmunizationItem item = new VacDedupRequest.ImmunizationItem();
