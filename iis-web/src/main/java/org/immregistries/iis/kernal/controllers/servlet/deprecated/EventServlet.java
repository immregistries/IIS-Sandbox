...
public class EventServlet extends PopController {
    ...
    // try {
    // if (tenant == null) {
    // tenant = ServletHelper.authenticateTenant(userId, password, facilityId);
    // }
    // if (tenant == null) {
    // resp.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
    // out.println(
    // "Access is not authorized. Facilityid, userid and/or password are not
    // recognized. ");
    // } else {
    ...
    // out.println(" <input class=\"w3-input\" type=\"password\" name=\"" +
    // PARAM_PASSWORD
    // + "\"/>");
